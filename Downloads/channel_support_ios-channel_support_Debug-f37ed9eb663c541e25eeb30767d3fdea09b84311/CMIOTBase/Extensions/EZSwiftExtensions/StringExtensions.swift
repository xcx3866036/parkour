...
//    }
    ...
    public func bold() -> NSAttributedString {
        let boldString = NSMutableAttributedString(string: self, attributes: [kCTFontAttributeName as NSAttributedStringKey: UIFont.boldSystemFont(ofSize: UIFont.systemFontSize)])
        return boldString
    }
    ...
    public func underline() -> NSAttributedString {
        let underlineString = NSAttributedString(string: self, attributes: [kCTUnderlineStyleAttributeName as NSAttributedStringKey: NSUnderlineStyle.styleSingle.rawValue])
    ...
    public func italic() -> NSAttributedString {
        let italicString = NSMutableAttributedString(string: self, attributes: [kCTFontAttributeName as NSAttributedStringKey: UIFont.italicSystemFont(ofSize: UIFont.systemFontSize)])
        return italicString
    }
    ...
    public func height(_ width: CGFloat, font: UIFont, lineBreakMode: NSLineBreakMode?) -> CGFloat {
        var attrib: [NSAttributedStringKey: AnyObject] = [kCTFontAttributeName as NSAttributedStringKey : font]
        if lineBreakMode != nil {
            let paragraphStyle = NSMutableParagraphStyle()
            paragraphStyle.lineBreakMode = lineBreakMode!
            attrib.updateValue(paragraphStyle, forKey: kCTParagraphStyleAttributeName as NSAttributedStringKey)
        }
    ...
    public func color(_ color: UIColor) -> NSAttributedString {
        let colorString = NSMutableAttributedString(string: self, attributes: [kCTForegroundColorAttributeName as NSAttributedStringKey: color])
        return colorString
    }
    ...
    public func colorSubString(_ subString: String, color: UIColor) -> NSMutableAttributedString {
        ...
        for range in ranges {
            attrText.addAttribute(kCTForegroundColorAttributeName as NSAttributedStringKey, value: color, range: range)
        }
        return attrText
    }
    ...
    public func includesEmoji() -> Bool {
        for i in 1...(self as NSString).length {
            let c: unichar = (self as NSString).character(at: i - 1)
