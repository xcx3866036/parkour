...
class CSButton: UIButton {
   ...
   private var imageSize: CGSize = CGSize.zero
    ...
    private func adjustTitleSize() -> CGSize {
        ...
        let titleSize = ((titleLabel?.text ?? "") as NSString).boundingRect(with: CGSize(width: CGFloat(MAXFLOAT), height: CGFloat(MAXFLOAT)), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedStringKey : titleLabel!.font], context: nil).size
