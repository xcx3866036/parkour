...
//  CMIOTBase
//
//  Created by junzhang on 2018/11/9.
...
class OrderSearchVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate {
    ...
    func searchEmployeeInfoList(){
        ...
        if likeName.length <= 0 {
            SVProgressHUD.showInfo(withStatus: "商品名称/产品编码/订单号")
            return
        }
