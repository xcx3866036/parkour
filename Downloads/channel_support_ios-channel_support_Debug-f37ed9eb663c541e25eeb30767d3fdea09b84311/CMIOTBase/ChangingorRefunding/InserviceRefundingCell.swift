...
class InserviceRefundingCell: UITableViewCell {
    ...
    lazy var orderNoLab: UILabel = {
        let lab = UIFactoryGenerateLab(fontSize: 15, color: RGB(28, g: 28, b: 28), placeText: "退货退款")
        return lab
    }()
...
//    }()
    ...
    lazy var scanBtn: UIButton = {
        let btn = UIFactoryGenerateBtn(fontSize: 12, color: RGB(36, g: 36, b: 36), placeText: "退货检查", imageName: "")
