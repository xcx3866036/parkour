...
class InserviceChangingCell: UITableViewCell {
    ...
    lazy var scanBtn: UIButton = {
        let btn = UIFactoryGenerateBtn(fontSize: 12, color: RGB(36, g: 36, b: 36), placeText: "扫码换新", imageName: "")
